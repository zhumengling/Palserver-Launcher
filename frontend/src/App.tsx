...
function App() {
  ...
  const [launcherVersion, setLauncherVersion] = useState('v0.1.2');
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-footer"><button className="version" title="检查启动器更新" onClick={checkLauncherUpdate}>{launcherVersion}{launcherUpdate?.updateAvailable && <i/>}</button></div>
      </aside>
